<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SustentabilidadPeatones
 *
...
class SustentabilidadPeatones extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->nombre                    = 'Peatones en Gómez Palacio';
...
FINAL;
    ...
    protected function seccion_otras_regiones_html() {
        return <<<FINAL
      <h3>Gráfica con los últimos datos de Peatones</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Peatones</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
...
FINAL;
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 12.0600 },{ region: 'Gómez Palacio', dato: 16.8900 },{ region: 'Lerdo', dato: 21.3200 },{ region: 'Matamoros', dato: 23.4500 },{ region: 'La Laguna', dato: 16.4400 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
