<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadViviendasHabitadas
 *
...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Viviendas Habitadas en Gómez Palacio</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2010-12-31', dato: 83973 },{ fecha: '2015-12-31', dato: 91600 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
FINAL;
    ...
    protected function seccion_otras_regiones_html() {
      ...
      <h3>Últimos datos de Viviendas Habitadas</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
