<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadMuertesPorAccidentesRelacionadosConTransporte
 *
...
class SociedadMuertesPorAccidentesRelacionadosConTransporte extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->nombre                    = 'Muertes por Accidentes Relacionados con Transporte en Gómez Palacio';
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 12.8247 },{ fecha: '2009-12-31', dato: 17.1989 },{ fecha: '2010-12-31', dato: 10.4357 },{ fecha: '2011-12-31', dato: 8.2509 },{ fecha: '2012-12-31', dato: 18.9430 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
