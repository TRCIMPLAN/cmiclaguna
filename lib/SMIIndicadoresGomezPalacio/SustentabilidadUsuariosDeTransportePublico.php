<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SustentabilidadUsuariosDeTransportePublico
 *
...
class SustentabilidadUsuariosDeTransportePublico extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->nombre                    = 'Usuarios de Transporte Público en Gómez Palacio';
...
FINAL;
    ...
    protected function seccion_otras_regiones_html() {
        return <<<FINAL
      <h3>Gráfica con los últimos datos de Usuarios de Transporte Público</h3>
      <div id="graficaOtrasRegiones" class="grafica"></div>
      <h3>Últimos datos de Usuarios de Transporte Público</h3>
      <table class="table table-hover table-bordered matriz">
        <thead>
          <tr>
            <th>Región</th>
...
FINAL;
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 36.6800 },{ region: 'Gómez Palacio', dato: 34.9900 },{ region: 'Lerdo', dato: 33.5200 },{ region: 'Matamoros', dato: 31.0800 },{ region: 'La Laguna', dato: 34.9100 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
