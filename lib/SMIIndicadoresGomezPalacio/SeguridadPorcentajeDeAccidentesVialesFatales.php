<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SeguridadPorcentajeDeAccidentesVialesFatales
 *
...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves                    = 'IMPLAN, Gómez Palacio, Vialidad, Movilidad, Seguridad, Salud';
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2012-12-31', dato: 2.0600 },{ fecha: '2013-12-31', dato: 1.8600 },{ fecha: '2014-12-31', dato: 1.7200 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
