<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresGomezPalacio SociedadViviendasConAguaDeLaRedPublica
 *
...
class SociedadViviendasConAguaDeLaRedPublica extends \SMIBase\PublicacionWeb {
    ...
    protected function seccion_datos_html() {
      ...
      <h3>Observaciones</h3>
<p>Consulta la <a href="http://www.inegi.org.mx/biinegi/">Base de Datos</a>. Las cifras 2015 corresponden a la Encuesta Intercensal de INEGI y son estimaciones.</p>
...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Viviendas con Agua de la Red Pública en Gómez Palacio</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2010-12-31', dato: 98.0300 },{ fecha: '2015-12-31', dato: 99.2900 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
FINAL;
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 99.2000 },{ region: 'Gómez Palacio', dato: 99.2900 },{ region: 'Lerdo', dato: 98.2500 },{ region: 'Matamoros', dato: 98.4600 },{ region: 'La Laguna', dato: 98.0400 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
