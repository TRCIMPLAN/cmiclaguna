...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Viviendas con Drenaje (sólo conexión a red pública) en La Laguna</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 84.0800 },{ fecha: '2009-12-31', dato: 83.0500 },{ fecha: '2010-12-31', dato: 82.0400 },{ fecha: '2011-12-31', dato: 84.3900 },{ fecha: '2012-12-31', dato: 86.8100 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
