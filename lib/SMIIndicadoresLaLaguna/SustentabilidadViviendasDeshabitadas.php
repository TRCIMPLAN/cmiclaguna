<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna SustentabilidadViviendasDeshabitadas
 *
...
FINAL;
    ...
    protected function seccion_grafica_1_html() {
        return <<<FINAL
      <h3>Gráfica de Viviendas Deshabitadas en La Laguna con fuente IMCO</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatosImco === 'undefined') {
    vargraficaDatosImco = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 22.1400 },{ fecha: '2009-12-31', dato: 22.1400 },{ fecha: '2010-12-31', dato: 22.1400 },{ fecha: '2011-12-31', dato: 22.1400 },{ fecha: '2012-12-31', dato: 22.1400 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
