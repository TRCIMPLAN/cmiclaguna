<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLaLaguna SustentabilidadRedCarreteraAvanzada
 *
...
class SustentabilidadRedCarreteraAvanzada extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->nombre                    = 'Red Carretera Avanzada en La Laguna';
        ...
        $this->claves                    = 'IMPLAN, La Laguna, Índice de Competitividad Urbana, Infraestructura, Movilidad';
...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Red Carretera Avanzada en La Laguna</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 54.1400 },{ fecha: '2009-12-31', dato: 54.2000 },{ fecha: '2010-12-31', dato: 52.6100 },{ fecha: '2011-12-31', dato: 75.1500 },{ fecha: '2012-12-31', dato: 75.1500 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
