...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Flujo de Pasajeros Aéreos en Torreón</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 370.3688 },{ fecha: '2009-12-31', dato: 297.0495 },{ fecha: '2010-12-31', dato: 250.1342 },{ fecha: '2011-12-31', dato: 274.2926 },{ fecha: '2012-12-31', dato: 301.7549 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
