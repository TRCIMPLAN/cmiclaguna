...
<iframe width='100%' height='520' frameborder='0' src='https://implantorreon.cartodb.com/u/sigimplan/viz/0ccbc85e-de1e-11e4-b994-0e9d821ea90d/embed_map' allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>
      <h3>Notas</h3>
<p><a href="https://implantorreon.cartodb.com/u/sigimplan/viz/0ccbc85e-de1e-11e4-b994-0e9d821ea90d/embed_map">Ver a pantalla completa</a></p>
...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Viviendas con Internet en Torreón</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2010-12-31', dato: 28.0000 },{ fecha: '2015-12-31', dato: 42.3100 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
FINAL;
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 42.3100 },{ region: 'Gómez Palacio', dato: 29.8500 },{ region: 'Lerdo', dato: 27.1100 },{ region: 'Matamoros', dato: 17.8600 },{ region: 'La Laguna', dato: 23.0000 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
