<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SociedadViviendasConEnergiaElectrica
 *
 ...
 */
class SociedadViviendasConEnergiaElectrica extends \SMIBase\PublicacionWeb {
...
<iframe width='100%' height='520' frameborder='0' src='https://implantorreon.cartodb.com/u/sigimplan/viz/b096d846-de20-11e4-868a-0e4fddd5de28/embed_map' allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>
      <h3>Notas</h3>
<p><a href="https://implantorreon.cartodb.com/u/sigimplan/viz/b096d846-de20-11e4-868a-0e4fddd5de28/embed_map">Ver a pantalla completa</a></p>
...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Viviendas con Energía Eléctrica en Torreón</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2010-12-31', dato: 99.6100 },{ fecha: '2015-12-31', dato: 99.8300 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
