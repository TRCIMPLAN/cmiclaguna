...
<iframe width='100%' height='520' frameborder='0' src='https://implantorreon.cartodb.com/u/sigimplan/viz/e149b360-dc9e-11e4-a1e7-0e853d047bba/embed_map' allowfullscreen webkitallowfullscreen mozallowfullscreen oallowfullscreen msallowfullscreen></iframe>
      <h3>Notas</h3>
<p><a href="https://implantorreon.cartodb.com/u/sigimplan/viz/e149b360-dc9e-11e4-a1e7-0e853d047bba/embed_map">Ver a pantalla completa</a></p>
...
FINAL;
    ...
    protected function seccion_grafica_1_html() {
        return <<<FINAL
      <h3>Gráfica de Viviendas Deshabitadas en Torreón con fuente IMCO</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatosImco === 'undefined') {
    vargraficaDatosImco = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 22.9700 },{ fecha: '2009-12-31', dato: 22.9700 },{ fecha: '2010-12-31', dato: 22.9700 },{ fecha: '2011-12-31', dato: 22.9700 },{ fecha: '2012-12-31', dato: 22.9700 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
