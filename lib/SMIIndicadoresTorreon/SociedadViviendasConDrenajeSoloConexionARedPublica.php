...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Viviendas con Drenaje (sólo conexión a red pública) en Torreón</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 89.2300 },{ fecha: '2009-12-31', dato: 87.3200 },{ fecha: '2010-12-31', dato: 85.4500 },{ fecha: '2011-12-31', dato: 87.6600 },{ fecha: '2012-12-31', dato: 89.9200 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
