<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresTorreon SustentabilidadRedCarreteraAvanzada
 *
...
class SustentabilidadRedCarreteraAvanzada extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->nombre                    = 'Red Carretera Avanzada en Torreón';
        ...
        $this->claves                    = 'IMPLAN, Torreón, Índice de Competitividad Urbana, Infraestructura, Movilidad';
...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Red Carretera Avanzada en Torreón</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 15.0900 },{ fecha: '2009-12-31', dato: 15.0900 },{ fecha: '2010-12-31', dato: 14.8100 },{ fecha: '2011-12-31', dato: 100.0000 },{ fecha: '2012-12-31', dato: 100.0000 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
