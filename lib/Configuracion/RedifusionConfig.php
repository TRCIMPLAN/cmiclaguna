<?php
/**
 * TrcIMPLAN CMIC Laguna - Redifusion Config
 *
...
class RedifusionConfig {
    ...
    public $sitio_url         = 'http://www.trcimplan.gob.mx/cmiclaguna'; // Sin diagonal al final
    public $sitio_descripcion = 'Últimas publicaciones de CMIC Laguna e IMPLAN de Torreón.';
