<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo EconomiaCrecimientoDeLaManchaUrbana
 *
...
class EconomiaCrecimientoDeLaManchaUrbana extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->nombre                    = 'Crecimiento de la Mancha Urbana en Lerdo';
        ...
        $this->claves                    = 'IMPLAN, Lerdo, Índice de Competitividad Urbana, Infraestructura';
...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Crecimiento de la Mancha Urbana en Lerdo</h3>
