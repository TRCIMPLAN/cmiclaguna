<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SociedadViviendasConDrenajeSoloConexionARedPublica
 *
...
class SociedadViviendasConDrenajeSoloConexionARedPublica extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->nombre                    = 'Viviendas con Drenaje (sólo conexión a red pública) en Lerdo';
...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Viviendas con Drenaje (sólo conexión a red pública) en Lerdo</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 75.0400 },{ fecha: '2009-12-31', dato: 75.0600 },{ fecha: '2010-12-31', dato: 75.0700 },{ fecha: '2011-12-31', dato: 77.2600 },{ fecha: '2012-12-31', dato: 79.5100 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
