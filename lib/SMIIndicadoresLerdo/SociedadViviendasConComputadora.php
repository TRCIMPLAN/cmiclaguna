<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SociedadViviendasConComputadora
 *
...
FINAL;
    ...
    protected function seccion_grafica_1_html() {
        return <<<FINAL
      <h3>Gráfica de Viviendas con Computadora en Lerdo con fuente IMCO</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatosImco === 'undefined') {
    vargraficaDatosImco = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 21.6800 },{ fecha: '2009-12-31', dato: 23.7400 },{ fecha: '2010-12-31', dato: 25.9900 },{ fecha: '2011-12-31', dato: 27.2200 },{ fecha: '2012-12-31', dato: 28.5100 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
FINAL;
    ...
    protected function seccion_grafica_2_html() {
        return <<<FINAL
      <h3>Gráfica de Viviendas con Computadora en Lerdo con fuente INEGI</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatosInegi === 'undefined') {
    vargraficaDatosInegi = Morris.Line({
      ...
      data: [{ fecha: '2010-12-31', dato: 27.4700 },{ fecha: '2015-12-31', dato: 28.4800 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
