<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SustentabilidadMotorizacion
 *
...
class SustentabilidadMotorizacion extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves                    = 'IMPLAN, Lerdo, Recursos Naturales, Movilidad, Vialidad';
...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Motorización en Lerdo</h3>
...
FINAL;
  ...
  if (typeof vargraficaOtrasRegiones === 'undefined') {
    vargraficaOtrasRegiones = Morris.Bar({
      ...
      data: [{ region: 'Torreón', dato: 211 },{ region: 'Gómez Palacio', dato: 405 },{ region: 'Lerdo', dato: 304 },{ region: 'Matamoros', dato: 170 },{ region: 'La Laguna', dato: 271 }],
      xkey: 'region',
      ykeys: ['dato'],
      labels: ['Dato'],
      barColors: ['#FF5B02']
