<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresLerdo SociedadViviendasConPisoDeTierra
 *
...
class SociedadViviendasConPisoDeTierra extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->nombre                    = 'Viviendas con Piso de Tierra en Lerdo';
...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Viviendas con Piso de Tierra en Lerdo</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 2.8900 },{ fecha: '2009-12-31', dato: 2.0700 },{ fecha: '2010-12-31', dato: 1.4900 },{ fecha: '2011-12-31', dato: 1.6000 },{ fecha: '2012-12-31', dato: 1.7200 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
