...
class Contacto extends \Base\Publicacion {
    ...
    //~ $this->autor                     = '';
        $this->fecha                     = '2017-02-15T11:00';
        // El nombre del archivo a crear
        $this->archivo                   = 'contacto';
        // La descripción y claves dan información a los buscadores y redes sociales
        $this->descripcion               = 'Datos de contacto como redes sociales, correos electrónicos y teléfonos de CANACO e IMPLAN Torreón.';
        $this->claves                    = 'CANACO, IMPLAN, Torreon, Contacto';
