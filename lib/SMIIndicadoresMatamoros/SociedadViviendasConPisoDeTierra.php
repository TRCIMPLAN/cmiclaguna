<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadViviendasConPisoDeTierra
 *
...
class SociedadViviendasConPisoDeTierra extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->nombre                    = 'Viviendas con Piso de Tierra en Matamoros';
...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Viviendas con Piso de Tierra en Matamoros</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 1.9800 },{ fecha: '2009-12-31', dato: 1.6300 },{ fecha: '2010-12-31', dato: 1.3400 },{ fecha: '2011-12-31', dato: 1.5200 },{ fecha: '2012-12-31', dato: 1.7100 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
