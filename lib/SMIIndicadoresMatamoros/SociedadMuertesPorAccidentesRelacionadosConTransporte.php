...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Muertes por Accidentes Relacionados con Transporte en Matamoros</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 12.1805 },{ fecha: '2009-12-31', dato: 3.7186 },{ fecha: '2010-12-31', dato: 14.7579 },{ fecha: '2011-12-31', dato: 13.7282 },{ fecha: '2012-12-31', dato: 5.4425 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
