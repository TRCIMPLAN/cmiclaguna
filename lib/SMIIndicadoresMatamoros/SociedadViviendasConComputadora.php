<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SociedadViviendasConComputadora
 *
...
FINAL;
    ...
    protected function seccion_grafica_1_html() {
        return <<<FINAL
      <h3>Gráfica de Viviendas con Computadora en Matamoros con fuente IMCO</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatosImco === 'undefined') {
    vargraficaDatosImco = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 15.7300 },{ fecha: '2009-12-31', dato: 17.3000 },{ fecha: '2010-12-31', dato: 19.0400 },{ fecha: '2011-12-31', dato: 20.3800 },{ fecha: '2012-12-31', dato: 21.8200 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
...
FINAL;
    ...
    protected function seccion_grafica_2_html() {
        return <<<FINAL
      <h3>Gráfica de Viviendas con Computadora en Matamoros con fuente INEGI</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatosInegi === 'undefined') {
    vargraficaDatosInegi = Morris.Line({
      ...
      data: [{ fecha: '2010-12-31', dato: 18.7300 },{ fecha: '2015-12-31', dato: 20.8500 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
