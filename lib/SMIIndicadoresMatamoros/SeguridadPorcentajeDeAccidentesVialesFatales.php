<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SeguridadPorcentajeDeAccidentesVialesFatales
 *
...
class SeguridadPorcentajeDeAccidentesVialesFatales extends \SMIBase\PublicacionWeb {
    ...
    public function __construct() {
        ...
        $this->claves                    = 'IMPLAN, Matamoros, Vialidad, Movilidad, Seguridad, Salud';
...
FINAL;
    ...
    protected function seccion_grafica_html() {
        return <<<FINAL
      <h3>Gráfica de Porcentaje de Accidentes Viales Fatales en Matamoros</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatos === 'undefined') {
    vargraficaDatos = Morris.Line({
      ...
      data: [{ fecha: '2012-12-31', dato: 1.0300 },{ fecha: '2013-12-31', dato: 1.8600 },{ fecha: '2014-12-31', dato: 1.8200 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
