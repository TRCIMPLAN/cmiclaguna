<?php
/**
 * TrcIMPLAN Sitio Web - SMIIndicadoresMatamoros SustentabilidadViviendasDeshabitadas
 *
...
Fuente: INEGI (Censo de Población y Vivienda).';
        $this->claves                    = 'IMPLAN, Matamoros, Vivienda, Índice de Competitividad Urbana';
...
FINAL;
    ...
    protected function seccion_grafica_1_html() {
        return <<<FINAL
      <h3>Gráfica de Viviendas Deshabitadas en Matamoros con fuente IMCO</h3>
...
FINAL;
  ...
  if (typeof vargraficaDatosImco === 'undefined') {
    vargraficaDatosImco = Morris.Line({
      ...
      data: [{ fecha: '2008-12-31', dato: 15.0100 },{ fecha: '2009-12-31', dato: 15.0100 },{ fecha: '2010-12-31', dato: 15.0100 },{ fecha: '2011-12-31', dato: 15.0100 },{ fecha: '2012-12-31', dato: 15.0100 }],
      xkey: 'fecha',
      ykeys: ['dato'],
      labels: ['Dato'],
      lineColors: ['#FF5B02'],
